    ...
    <div className="overflow-x-hidden min-h-screen">
      ...
      >
        <div className="relative z-10 flex-1 flex items-center">
          <div className="container mx-auto px-4 md:px-40 max-w-full mt-12 md:mt-22">
            <h1
      ...
      <section className="bg-[#A9CE42] py-16 lg:py-24">
        <div className="container mx-auto px-4 md:px-40 max-w-full text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[42%_minmax(0,58%)] gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
            <div>
              ...
              <p className="font-noto-condensed text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] leading-[1.17] font-normal text-[#EFF3CE] mt-6 max-w-2xl">
                ...
                <br className="hidden md:inline" /> sustentáveis.
              </p>
            </div>
                ...
                <div className="bg-[#EFF3CE] p-5 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300">
                  <div className="flex items-center space-x-4">
                    <div className="w-40 h-50 md:w-50 md:h-60 rounded-lg overflow-hidden shadow-md">
                      <Image
                        src="/premio2.png"
                        alt="Innovation Awards 23 - Produto Mais Inovador"
                        width={150}
                        height={150}
                        className="w-full h-full object-cover"
                      />
                    ...
                    <div className="flex-1">
                      <h4 className="font-anton text-[#005233] text-lg">Innovation Awards</h4>
                      <p className="font-noto-condensed text-[#005233] text-sm font-bold">Produto Mais Inovador</p>
                      <span className="text-[#7CA800] text-xs font-noto-condensed">2023</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#EFF3CE] p-5 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300">
                  <div className="flex items-center space-x-4">
                    <div className="w-40 h-50 md:w-50 md:h-60 rounded-lg overflow-hidden shadow-md">
                      <Image
                        src="/premio3.png"
                        alt="Troféus dourados em vitrine"
                        width={64}
                        height={64}
                        className="w-full h-full object-cover"
                      />
                    ...
                    <div className="flex-1">
                      <h4 className="font-anton text-[#005233] text-lg">Múltiplos Prêmios</h4>
                      <p className="font-noto-condensed text-[#005233] text-sm font-bold">Reconhecimento Contínuo</p>
                      <span className="text-[#7CA800] text-xs font-noto-condensed">2022-2024</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="sobre" className="">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="bg-[#7CA800]">
            <div className="p-12 px-4 md:px-40">
          ...
          <div className="bg-[#EFF3CE] p-4 md:p-12">
      ...
      <section id="servicos" className="bg-[#EFF3CE] py-16 lg:py-20 overflow-hidden">
        <div className="container mx-auto px-4 md:px-40">
          <div className="text-center mb-16 max-w-6xl mx-auto">
            <p className="font-noto-condensed text-[28px] sm:text-[32px] md:text-[38px] lg:text-[42px] xl:text-[45px] leading-[1.04] font-bold text-[#005233] mb-2 md:mb-8 text-left max-w-4xl mx-auto break-words">
              Do diagnóstico estratégico ao <br className="hidden sm:block" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-7xl mx-auto">
            ...
            <div className="bg-[#005233] p-10 sm:-10 md:p-12 lg:p-16 rounded-3xl md:col-span-2">
              ...
              <p className="font-noto-condensed text-[20px] sm:text-[24px] md:text-[26px] lg:text-[30px] leading-[1.07] font-normal text-[#EFF3CE] break-words">
                Otimizamos processos e criamos estratégias para <br className="hidden sm:block" />
                maximizar resultados sustentáveis.
              </p>
            </div>

            {/* Card 2 - Desenvolvimento de Produto */}
            <div className="bg-[#7CA800] p-10 sm:-10 md:p-12 lg:p-16 rounded-3xl">
              <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-4">
              ...
              <p className="font-noto-condensed text-[18px] sm:text-[20px] md:text-[24px] lg:text-[26px] leading-[1.07] font-normal text-[#EFF3CE] break-words">
                Criamos produtos inovadores com responsabilidade técnica e suporte em projetos.
              </p>
            </div>

            {/* Card 3 - Treinamentos */}
            <div className="bg-[#BFDD50] p-10 sm:-10 md:p-12 lg:p-16 rounded-3xl">
              <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-4">
              ...
              <p className="font-noto-condensed text-[18px] sm:text-[20px] md:text-[24px] lg:text-[26px] leading-[1.07] font-normal text-[#005233] break-words">
                Capacitamos equipes com treinamentos personalizados e conteúdos técnicos de alto impacto.
              </p>
            </div>

            {/* Card 4 - Novos negócios */}
            <div className="bg-[#9AD000] p-10 sm:-10 md:p-12 lg:p-16 rounded-3xl">
              <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-4">
                <h3 className="font-anton text-[28px] sm:text-[32px] md:text-[38px] lg:text-[42px] leading-[1] font-normal text-[#005233] break-words">
                  Novos negócios
                  <br />e Branding
              ...
              <p className="font-noto-condensed text-[18px] sm:text-[20px] md:text-[24px] lg:text-[26px] leading-[1.07] font-normal text-[#005233] break-words">
                Construímos marcas e negócios que conectam com o futuro sustentável.
              </p>
            </div>

            {/* Card 5 - Comunicação */}
            <div className="bg-[#B6DB2C] p-10 sm:-10 md:p-12 lg:p-16 rounded-3xl">
              <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-4">
                <h3 className="font-anton text-[28px] sm:text-[32px] md:text-[38px] lg:text-[42px] leading-[1] font-normal text-[#005233] break-words">
              ...
              <p className="font-noto-condensed text-[18px] sm:text-[20px] md:text-[24px] lg:text-[26px] leading-[1.07] font-normal text-[#005233] break-words">
                Gerenciamos projetos com precisão, do planejamento à entrega final que conectam marcas, pessoas e valor.
              </p>
            </div>
          </div>
        </div>
